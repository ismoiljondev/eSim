    ...
    return (
        <div className='flex flex-col gap-4'>
            ...
            <div className='grid grid-cols-3 gap-6'>
                <div className='flex flex-col items-center text-center gap-2 border rounded-xl p-3 hover:cursor-pointer hover:scale-110 duration-800'>
                    <IconNumber1 strokeWidth={1} size={70} />
                    <p className='text-xl font-medium'>{t("step1_title")}</p>
                    <p className='text-sm'>{t("step1_desc")}</p>
                </div>
                <div className='flex flex-col items-center text-center gap-2 border rounded-xl p-3 hover:cursor-pointer hover:scale-110 duration-800'>
                    <IconNumber2 strokeWidth={1} size={70} />
                    <p className='text-xl font-medium'>{t("step2_title")}</p>
                    <p className='text-sm'>{t("step2_desc")}</p>
                </div>
                <div className='flex flex-col items-center text-center gap-2 border rounded-xl p-3 hover:cursor-pointer hover:scale-110 duration-800'>
                    <IconNumber3 strokeWidth={1} size={70} />
