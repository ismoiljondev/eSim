        ...
        <div className='flex flex-col gap-4'>
            ...
            <div className='grid grid-cols-3 gap-6'>
                <div className='relative flex flex-col items-center text-center gap-2 border rounded-xl p-3 hover:cursor-pointer hover:scale-110 duration-800'>
                    <div className='absolute top-3 left-3 border rounded-lg p-1'><IconNumber1 strokeWidth={1} size={30} /></div>
                ...
                <div className='relative flex flex-col items-center text-center gap-2 border rounded-xl p-3 hover:cursor-pointer hover:scale-110 duration-800'>
                    <div className='absolute top-3 left-3 border rounded-lg p-1'><IconNumber2 strokeWidth={1} size={30} /></div>
                    <div className='flex flex-col mt-10'>
                ...
                <div className='relative flex flex-col items-center text-center gap-2 border rounded-xl p-3 hover:cursor-pointer hover:scale-110 duration-800'>
                    <div className='absolute top-3 left-3 border rounded-lg p-1'><IconNumber3 strokeWidth={1} size={30} /></div>
                    <div className='flex flex-col mt-10'>
